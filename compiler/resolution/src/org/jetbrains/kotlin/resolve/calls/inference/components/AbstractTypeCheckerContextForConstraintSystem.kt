        ...
        val lowerConstraint = when (typeVariable) {
            is SimpleTypeMarker ->
                ...
                if (typeVariable.isMarkedNullable()) {
                    ...
                    if (typeVariableTypeConstructor is TypeVariableTypeConstructor && typeVariableTypeConstructor.usagesInfo?.isContainedInInvariantOrContravariantPositions == true) {
